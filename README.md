...
Модули в целом итак синглтоны, то есть если мы имспортируем два модуля с одинаковым названием, то на самом деле это один модуль из-за того, что действует кеш.
...
Можно использовать там, где есть различные реализации.
Можно использовать для логиварония.
